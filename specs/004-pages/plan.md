...
**Storage**: N/A — Projects/About/CV content are in-source `List<...>` literals (FR-006/FR-012),
not fetched or persisted. `trophies.json` is the one fetched artifact: a hand-authored static
file served as a Kobweb public resource, not generated by any automation this phase (FR-008; the
nightly PSN job is Phase 4/ROADMAP F025).
...
```text
site/
├── build.gradle.kts                                     # MODIFIED: kobweb.app.export.extraRoutes (research.md §1)
└── src/jsMain/
    └── kotlin/com/anjo/anjosite/
        ...
        │   │   └── ContactPrompt.kt                       # NEW: ContactMessage + ContactPrompt composable (FR-014 exception)
        │   └── sections/
        │       ├── NavHeader.kt                           # MODIFIED: + mediaPrint hide rule (FR-017, research.md §5)
        │       └── Footer.kt                               # MODIFIED: + mediaPrint hide rule (FR-017, research.md §5)
        └── pages/
            ├── Index.kt                                   # MODIFIED: real Home content (FR-001/FR-002)
            ├── About.kt                                    # NEW: route doesn't exist today (FR-003/FR-004)
            ├── Projects.kt                                 # MODIFIED: real grid from in-source ProjectEntry list (FR-005/FR-006/FR-013)
